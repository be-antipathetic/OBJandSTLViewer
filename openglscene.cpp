...
void OpenGLScene::openloadModel()
{
    QString filePath = QFileDialog::getOpenFileName(0, tr("Choose model"), QString(), QLatin1String("*.obj *.stl"));
    if (filePath.isEmpty())
    {
        return;  // 防止空路径导致的后续问题
    }
